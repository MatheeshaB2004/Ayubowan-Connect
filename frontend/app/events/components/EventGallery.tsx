  ...
  return (
    <div className="mb-8">
      ...
      <div className="relative rounded-xl overflow-hidden mb-3 h-56 sm:h-72 bg-gray-100">
        ...
        {isEventCreator && (
          <button
            onClick={() => handleDeleteImage(images[galleryIndex].id)}
      ...
      <div className="flex gap-2 overflow-x-auto pb-2">
        {images.map((img, i) => (
          <button
            ...
            className={`w-20 h-14 rounded-lg overflow-hidden flex-shrink-0 border-2 transition-colors relative group ${
              i === galleryIndex
                ? "border-[#0d9488]"
          ...
          >
            ...
            {isEventCreator && (
              <button
                ...
                className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity disabled:opacity-100"
              >
