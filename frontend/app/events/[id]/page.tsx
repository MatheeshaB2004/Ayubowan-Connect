...
// ─────────────────────────────────────────────────────────────────────────────
// Types for extra UI data (mock until backend provides)
// ─────────────────────────────────────────────────────────────────────────────
interface Review {
  id: number;
  initials: string;
...
const MOCK_ATTENDEES: Attendee[] = [
  { initials: "EW", name: "Emma W.",  country: "Australia", color: "#0d9488" },
  { initials: "JD", name: "John D.",  country: "USA",       color: "#0d9488" },
  { initials: "LM", name: "Lisa M.",  country: "UK",        color: "#0d9488" },
  { initials: "DK", name: "David K.", country: "Canada",    color: "#0d9488" },
  { initials: "AS", name: "Anne S.",  country: "Germany",   color: "#0d9488" },
  { initials: "TR", name: "Tom R.",   country: "France",    color: "#0d9488" },
];
...
export default function EventDetailPage() {
  ...
  // - Vendor → can view but CANNOT register
  // - Traveller → can view AND register
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      setRegError("Registration failed. You may already be registered.");
    } finally {
      setRegLoading(false);
    }
  };
  ...
  // Gallery images — use event image + placeholders until multiple images exist
  ...
  return (
    <>
      <div className="min-h-screen bg-[#f9fafb]">
        ...
        <div className="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 sm:px-6 h-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`w-8 h-8 flex items-center justify-center rounded-full transition-colors ${saved ? "text-red-500 hover:bg-red-50" : "text-gray-500 hover:text-gray-700 hover:bg-gray-100"}`}
            >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              <Section title="About This Event">
                {event.description ? (
                  <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
                    ...
                    <p>
                      This hands-on experience is perfect for both beginners and those with some prior knowledge.
                      All materials and equipment are provided, and you&apos;ll leave with new skills and a deeper
                      appreciation for Sri Lankan culture.
                    </p>
                  </div>
                ) : (
                  ...
                  <div className="flex gap-2">
                    {galleryImages.map((img, i) => (
                      <button
                        ...
                        className={`w-20 h-14 rounded-lg overflow-hidden flex-shrink-0 border-2 transition-colors ${i === galleryIndex ? "border-[#0d9488]" : "border-transparent"}`}
                      >
            ...
            {/* ════════════════════════════════════════════════════════════════
                RIGHT COLUMN — sticky booking card + organiser + info
            ════════════════════════════════════════════════════════════════ */}
      ...
      {/* ── Registration popup ── traveller only ── */}
          ...
          {success ? (
            ...
            <>
              ...
              <div className="bg-[#f9fafb] rounded-xl border border-gray-100 p-4 mb-4">
                ...
                {event.vendor && (
                  <p className="text-xs text-[#21a17a] font-medium mb-2">{event.vendor.businessName}</p>
                )}
              ...
              <p className="text-xs text-gray-400 mb-4">
                By registering you confirm your interest in attending this event. Free cancellation up to 24 hours before the event.
              </p>
