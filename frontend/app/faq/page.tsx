...
function ContactBlock() {
  return (
    ...
    >
      ...
      <button className="inline-flex items-center justify-center px-8 py-3 rounded-xl bg-teal-600 text-white font-semibold hover:bg-teal-700 transition-all shadow-sm hover:shadow-md hover:shadow-teal-600/20 active:scale-95 text-sm">
        Contact Support
      </button>
    </motion.div>
  );
